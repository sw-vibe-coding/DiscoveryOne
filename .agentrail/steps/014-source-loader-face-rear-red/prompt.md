# Step: source-loader-face-rear-red
...
1. Add reg-rs case `d1_face_rear_power` that runs
   `d1 face examples/power.d1 --face rear`.
2. Capture the current RED output from the unsupported face path.
3. Do not implement rear-face projection in this step.
4. Update `docs/status.md` to show rear-face projection is the next RED
   M2 case.
...
`test: add rear face projection baseline`
